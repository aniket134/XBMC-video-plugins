...
from dv2.db.models import ZObject01
from dv2 import dsh_django_utils
from dv2 import dsh_django_request
...
class PersonAdmin(StrictPermission):
    ...
    list_filter = ['organization', 'ptype', 'gender',
                   'phone_std',
                   'phone_landline',
                   'timed_broadcast',
                   'current_dial',
...
class EventAdmin(StrictPermission):
    ...
    search_fields = ('description', 'dsh_uid_concerned',
                     'dsh_uid2', 'session',
                     'phone_number')
