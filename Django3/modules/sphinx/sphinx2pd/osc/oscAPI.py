...
def sendOSC(stufftosend, ipAddr='127.0.0.1', port=9000): # outSocket, 
...
def sendMsg(oscAddress, dataArray, ipAddr='127.0.0.1', port=9000):#, outSocket):
...
def sendBundle(bundle, ipAddr='127.0.0.1', port=9000):#, outSocket):
